<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.master" AutoEventWireup="true" CodeFile="Dboy.aspx.cs" Inherits="Dboy" EnableEventValidation="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <section class="content-header" >
        <h1 style="color:steelblue">Delivery Boy Section
                    ...
                    <div class="box-body ">
                          ...
                          <div class="col-lg-4" >
                                        ...
                                        <div class="col-lg-4" style="padding-top:5%" >
                                             <asp:Button ID="btnOrderUpd" runat="server" CssClass="btn btn-primary" Text="Delivered" Visible="false" OnClick="btnOrderUpd_Click" />
