                                    ...
                                    <div class="row">
                                     ...
                                     <div class="col-lg-6">
                                                ...
                                                <label class="" for="billing_first_name">First Name <abbr title="required" class="required">*</abbr>
                                                   &nbsp; <asp:Label runat="server" Text='<%# Eval("TOT_F_NAME") %>' ID="billing_first_name"   CssClass ="input-text "></asp:Label>
                                                </label>
                                               
                                           </div>
                                                 <div class="col-lg-6">
                                                <label class="" for="billing_last_name">Last Name <abbr title="required" class="required">*</abbr>
                                                   &nbsp;  <asp:Label ID="billing_last_name" Text='<%# Eval("TOT_L_NAME") %>' runat="server" name="billing_last_name" CssClass="input-text " />
                                                </label>
